...
Complete API documentation mapping for React frontend integration.
...
Standard REST API endpoints for app DocTypes.
...
Standard REST API endpoints for ERPNext DocTypes.
...
For React/Vite frontend integration:
